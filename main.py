...
st.markdown("<h1 class='main-header'> Browser AI Agent</h1>", unsafe_allow_html=True)
st.markdown("Interact with a powerful web browsing agent that can navigate and interact with web.")
    ...
    if not st.session_state.initialized:
        try:
            ...
            st.session_state.browser_agent = Agent(
                ...
                -Follow multi-step browsing sequnces to complete tasks
                """,
            ...
            st.session_state.intialize = True
